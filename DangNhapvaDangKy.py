    ...
    def Form_Resignter():
        ...
        def Add_UserJsonFile():
            ...
            data_json={
                ...
                "Password":FormDK["Mật khẩu:"].get().strip(),
                "Năm sinh":FormDK["Năm sinh:"].get().strip()
                }
            #Xử lý các ngoại lệ
            if not data_json['Tên người dùng'] or not data_json['Email'] or not data_json['Password'] or not data_json['Năm sinh']:
            ...
            #Xóa thông tin tại các ô entry để đăng ký tiếp
            for entry in FormDK.values():
